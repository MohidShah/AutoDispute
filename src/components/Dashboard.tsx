    ...
    <div className="min-h-screen bg-[#F5F7FA] flex">
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2">
          {[
            { Icon: LayoutDashboard, label: 'Disputes', active: true },
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <button className="px-6 py-3 bg-[#3366FF] text-white rounded-lg font-medium hover:bg-[#28C76F] transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center gap-2">
              <Plus size={20} />
              New Dispute
            </button>
          </div>
                ...
                <tbody>
                  {disputes.map((dispute) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <button className="text-[#3366FF] hover:text-[#28C76F] text-sm font-medium transition-colors">
                          View
                        </button>
                      </td>
                    </tr>
        ...
        <div className="fixed bottom-24 right-8 w-96 h-[500px] bg-white rounded-2xl shadow-2xl flex flex-col z-50">
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button className="px-4 py-2 bg-[#3366FF] text-white text-sm rounded-lg hover:bg-[#28C76F] transition-colors">
                Start a dispute
              </button>
