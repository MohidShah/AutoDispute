    ...
    <div className="min-h-screen bg-[#0A0D14] flex items-center justify-center px-4 py-12">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start managing disputes smarter today</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-800 p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="py-3 px-4 bg-gray-800 border border-gray-700 rounded-lg text-white hover:bg-gray-700 transition-colors flex items-center justify-center gap-2"
              >
